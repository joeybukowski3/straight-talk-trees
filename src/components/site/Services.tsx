  ...
  return (
    <section id="services" className="scroll-mt-24 bg-[color:var(--cream)]">
      <div className="section-shell section-pad">
        ...
        <p className="type-body-lg section-lede text-[color:var(--foreground)]/85">
        ...
        <ul className="mt-10 divide-y divide-[color:var(--border)] border-y border-[color:var(--border)]">
          {PRIMARY_SERVICES.map((service) => (
            <li
              key={service.title}
              className="grid gap-2 py-5 sm:grid-cols-[minmax(0,14rem)_1fr] sm:gap-8 sm:py-6"
            >
              ...
              <div className="min-w-0">
                <p className="type-body text-[color:var(--foreground)]/85">{service.description}</p>
                <p className="type-meta mt-2 text-[color:var(--foreground)]/70">
        ...
        <details className="group mt-10 border-t border-[color:var(--border)]">
