...
const NAV = [
  ...
  { to: "/emergency-tree-service", label: "Emergency Service" },
      ...
      <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center rounded-md border border-[color:var(--border)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--forest)] lg:hidden"
          >
            {open ? (
      ...
      {open && (
        ...
        >
          <ul className="mx-auto max-w-[1200px] px-4 py-2">
            {NAV.map((item) => (
              <li key={"to" in item ? item.to : item.href}>
                {"to" in item ? (
                  <Link
                    to={item.to}
